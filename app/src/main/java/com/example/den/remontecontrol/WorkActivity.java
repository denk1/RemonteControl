...
public class WorkActivity extends AppCompatActivity {
    ...
    TextView textViewJoystickState = null;
...
//        menu item clip handling
    ...
    public TextView getJoystickInd() { return textViewJoystickState; }
    ...
    class MonitoringStateTask extends AsyncTask<Void, Boolean,  Void> {
        ...
        protected void  onProgressUpdate(Boolean... states) {
            ...
            if(!states[1]) {
                ...
                txtViewControlConn.setText("соединение с сервером управления отсутствует");
            } else {
